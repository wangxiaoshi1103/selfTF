...
import torch
from models.semantic_fusion_ts.scaled_dot_product_attention import ScaledDotProductAttention
...
class InterpretableMultiHeadAttention(nn.Module):
    ...
    Attributes:
      ...
      w_o: Output weight matrix to project internal state to the original SELFTF
        state size
    """
    ...
    def __init__(self, n_head, d_model, dropout_rate):
        ...
        Args:
          n_head: Number of heads
          d_model: SELFTF state dimensionality
