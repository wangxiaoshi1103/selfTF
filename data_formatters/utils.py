...
def make_data_formatter(exp_name):
    ...
    data_formatter_class = {
        ...
        'experiment': data_formatters.experiment.ExperimentFormatter,
        'weibo': data_formatters.weibo.WeiboFormatter,
        'twitter': data_formatters.twitter.TwitterFormatter
    }
...
def data_csv_path(exp_name):
    csv_map = {
        ...
        'experiment': './data/experiment/hourly_experiment_10000.csv',
        'weibo': './data/weibo/5.17_half.csv',
        #'twitter': './data/weibo/5.17_half.csv',
        'twitter': './data/twitter/twitter.csv'
    }
